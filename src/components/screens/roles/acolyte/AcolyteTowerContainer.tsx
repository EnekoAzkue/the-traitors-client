  ...
  return (
    <View>
      <ScreenContainer backgroundImg={backgroundImage}>
        ...
        <IconButton width={100} height={50} hasBrightness={true} backgroundImage={Images.BACK_ARROW} buttonOnPress={() => setInitialScreen(null)} xPos={20} yPos={20} hasBorder={false} />
        }
        {children}
      </ScreenContainer>
    </View>

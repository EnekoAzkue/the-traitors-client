  ...
  return (
    <View>
      <ScreenContainer backgroundImg={backgroundImage}>
        ...
        <IconButton width={height * 0.07} height={height * 0.07} hasBrightness={true} backgroundImage={Images.BAG} buttonOnPress={undefined} xPos={width * 0.8} yPos={height * 0.9} hasBorder={false}   backgrounOpacity={0} />
